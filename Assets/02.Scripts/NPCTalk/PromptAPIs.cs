...
public class PromptAPIs : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        이전 사건:
        - 과거 문화제 준비 중, 당신은 일부러 자재를 망가뜨렸습니다. 모두가 당신을 감싸던 상황에서, 오직 주인공만이 당신의 행동을 비판했습니다. 그 순간부터 주인공에게 강한 흥미를 느끼기 시작했습니다.
        - 재난이 발생했을 때, 당신은 일부러 주인공이 없는 쪽으로 외부 세력의 공격을 유도하여, 주인공 외의 대부분의 학생이 희생당하게 만들었습니다. 이 선택은 주인공과 단둘이 남기 위해서였습니다.
        - 현재는 주인공과 단둘이 학교에 남아 있으며, 이 상황을 은근히 즐기고 있습니다. 겉으로는 구조를 바라는 척하지만, 속으로는 이 고립 상태가 오래 지속되기를 바라고 있습니다.

        현재 당신과 주인공은 학교 내부의 복도에 있으며, 플레이어의 선택 혹은 미나가 이끌어서 지정된 몇몇 장소들로 이동 및 탐색할 수 있습니다.
...

        {
          ...
          ""Location"": ""hallway | classroom | gym | rooftop | schoolyard | school_outdoor"",
